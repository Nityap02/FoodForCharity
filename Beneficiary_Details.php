...
<html>
    ...
    <script>
        function add()
        {
            window.location.href="beneficiary.htm";
        }
        </script>
</head>
    <body>
    <h1 align="center" style="color:#183b56;">BENEFICIARY DETAILS </h1>
            ...
            <table width="99%"   border="1" cellpadding="30" cellspacing="0.1">
                <thead>
                    ...
                    <tr bgcolor="#183b56" text="white">
                        ...
                        <th  style="background-color:#183b56;color:white;"colspan="2">
                            OPERATIONS</th>
                    </tr>
                </thead>
<?php
...
//     echo" Records found <br><br>";
    ...
    while($row=mysqli_fetch_assoc($query_run))
    {
      ...
      <tr>
        ...
        <td><a href="update.php?id=<?php echo $row['B_Id']; ?>" class="edit">Edit</a></td>
         <td><a href="delete.php?id=<?php echo $row['B_Id']; ?>" class="delete">Delete</a></td>
      <?php
    }
    ?>
    </table>
